package com.casinocards.appmagicTeenpatti.Activity;
...
import com.casinocards.appmagicTeenpatti.Utils.PicassoImageLoadingService;
import com.casinocards.appmagicTeenpatti._AdharBahar.Andhar_Bahar_NewUI;
import com.casinocards.appmagicTeenpatti._DragonTiger.DragonTiger_A;
import com.casinocards.appmagicTeenpatti._SevenUpGames.SevenUp_A;
import com.casinocards.appmagicTeenpatti._TeenPatti.PublicTable_New;
import com.casinocards.appmagicTeenpatti.Utils.MainSliderAdapter;
...
import com.casinocards.appmagicTeenpatti.Adapter.HomegameListAdapter;
import com.casinocards.appmagicTeenpatti.BaseActivity;
import com.casinocards.appmagicTeenpatti.Comman.CommonAPI;
import com.casinocards.appmagicTeenpatti.Comman.DialogRestrictUser;
import com.casinocards.appmagicTeenpatti.Comman.DialogSettingOption;
import com.casinocards.appmagicTeenpatti.Details.GameDetails_A;
import com.casinocards.appmagicTeenpatti.Interface.OnItemClickListener;
import com.casinocards.appmagicTeenpatti.LocationManager.GetLocationlatlong;
import com.casinocards.appmagicTeenpatti.LocationManager.GpsUtils;
import com.casinocards.appmagicTeenpatti.Menu.DialogDailyBonus;
import com.casinocards.appmagicTeenpatti.Menu.DialogReferandEarn;
import com.casinocards.appmagicTeenpatti.Menu.DialogUserRanking;
import com.casinocards.appmagicTeenpatti.MyFlowLayout;
import com.casinocards.appmagicTeenpatti.RedeemCoins.WithdrawalList;
import com.casinocards.appmagicTeenpatti.Statement;
import com.casinocards.appmagicTeenpatti.Utils.Sound;
import com.casinocards.appmagicTeenpatti._AnimalRoulate.AnimalRoulette_A;
import com.casinocards.appmagicTeenpatti._Aviator.Aviator_Game_Activity;
import com.casinocards.appmagicTeenpatti._CarRoullete.CarRoullete_A;
import com.casinocards.appmagicTeenpatti._CoinFlip.HeadTail_A;
import com.casinocards.appmagicTeenpatti._ColorPrediction.ColorPrediction;
import com.casinocards.appmagicTeenpatti._ColorPrediction.ColorPrediction1;
import com.casinocards.appmagicTeenpatti._ColorPrediction.ColorPrediction3;
import com.casinocards.appmagicTeenpatti.Fragments.ActiveTables_BF;
import com.casinocards.appmagicTeenpatti.Fragments.UserInformation_BT;
...
import com.casinocards.appmagicTeenpatti._LuckJackpot.LuckJackPot_A;
import com.casinocards.appmagicTeenpatti._Poker.Fragment.PokerActiveTables_BF;
import com.casinocards.appmagicTeenpatti._RedBlack.RedBlackPot_A;
import com.casinocards.appmagicTeenpatti._Rummy.RummPrivate;
import com.casinocards.appmagicTeenpatti._RummyDeal.DialogDealType;
import com.casinocards.appmagicTeenpatti._RummyDeal.Fragments.RummyDealActiveTables_BF;
import com.casinocards.appmagicTeenpatti._RummyDeal.RummyDealGame;
import com.casinocards.appmagicTeenpatti._RummyPull.Fragments.RummyActiveTables_BF;
import com.casinocards.appmagicTeenpatti._Tournament.TourList;
import com.casinocards.appmagicTeenpatti._baccarat.Baccarat_A;
import com.casinocards.appmagicTeenpatti._jhandhiMunda.JhandhiMunda_A;
import com.casinocards.appmagicTeenpatti._rouleteGame.RouleteGame_A;
import com.casinocards.appmagicTeenpatti.account.LoginScreen;
import com.casinocards.appmagicTeenpatti.model.BannerModel;
import com.casinocards.appmagicTeenpatti.model.HomescreenModel;
...
import static com.casinocards.appmagicTeenpatti.GAMES.ANDHAR_BAHAR;
import static com.casinocards.appmagicTeenpatti.GAMES.ANIMAL_ROULETTE;
import static com.casinocards.appmagicTeenpatti.GAMES.AVIATOR;
import static com.casinocards.appmagicTeenpatti.GAMES.MINES;
import static com.casinocards.appmagicTeenpatti.GAMES.BACCARAT;
import static com.casinocards.appmagicTeenpatti.GAMES.CAR_ROULETTE;
import static com.casinocards.appmagicTeenpatti.GAMES.COLOUR_PREDICTION;
import static com.casinocards.appmagicTeenpatti.GAMES.COLOUR_PREDICTION1;
import static com.casinocards.appmagicTeenpatti.GAMES.CUSTOM_TABLE;
import static com.casinocards.appmagicTeenpatti.GAMES.DEAL_RUMMY;
import static com.casinocards.appmagicTeenpatti.GAMES.DRAGON_TIGER;
import static com.casinocards.appmagicTeenpatti.GAMES.HEAD_TAIL;
import static com.casinocards.appmagicTeenpatti.GAMES.JACKPOT_3PATTI;
import static com.casinocards.appmagicTeenpatti.GAMES.JHANDHI_MUNDA;
import static com.casinocards.appmagicTeenpatti.GAMES.LUDO_GAME_COMPUTER;
import static com.casinocards.appmagicTeenpatti.GAMES.LUDO_GAME_ONLINE;
import static com.casinocards.appmagicTeenpatti.GAMES.LUDO_GAME_PLAY_LOCAL;
import static com.casinocards.appmagicTeenpatti.GAMES.POINT_RUMMY;
import static com.casinocards.appmagicTeenpatti.GAMES.POKER_GAME;
import static com.casinocards.appmagicTeenpatti.GAMES.POOL_RUMMY;
import static com.casinocards.appmagicTeenpatti.GAMES.PRIVATE_RUMMY;
import static com.casinocards.appmagicTeenpatti.GAMES.PRIVATE_TABLE;
import static com.casinocards.appmagicTeenpatti.GAMES.RED_BLACK;
import static com.casinocards.appmagicTeenpatti.GAMES.SEVEN_UP_DOWN;
import static com.casinocards.appmagicTeenpatti.GAMES.TEENPATTI;
import static com.casinocards.appmagicTeenpatti.GAMES.ROULETTE;
import static com.casinocards.appmagicTeenpatti.GAMES.TOURNAMENT;
import static com.casinocards.appmagicTeenpatti.GAMES.COLOUR_PREDICTION3;
import static com.casinocards.appmagicTeenpatti.LocationManager.GpsUtils.ENABLE_LOCATION_CODE;
import static com.casinocards.appmagicTeenpatti.Utils.Functions.convertDpToPixel;
...
//                LoadFragment(new WalletFragment());
        ...
        findViewById(R.id.lnr_spinner).setOnClickListener(v -> startActivity(new Intent(context, com.casinocards.appmagicTeenpatti.Activity.Spinner_Wheels.class)));
        findViewById(R.id.lnr_spin_win).setOnClickListener(v -> startActivity(new Intent(context, com.casinocards.appmagicTeenpatti.Activity.Spinner_Wheels_Reward.class)));
...
//                showRedeemDailog();
        ...
        findViewById(R.id.iv_add).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, com.casinocards.appmagicTeenpatti.Activity.BuyChipsList.class);
...
//                    DialogRummyCreateTable.getInstance(context).show();
    ...
    private List<HomescreenModel> getGameList() {
        ...
        if (SharePref.getIsDragonTigerVisible())
            arraylist.add(new HomescreenModel(9, DRAGON_TIGER, R.drawable.dragan_tiger, "slots"));

        if (SharePref.getIsAndharBaharVisible())
            arraylist.add(new HomescreenModel(10, ANDHAR_BAHAR, R.drawable.andar_bahar, "slots"));
        //arraylist.add(new HomescreenModel(10, ANDHAR_BAHAR, R.drawable.home_andhar_bhar, "slots"));

        if (SharePref.getIsTeenpattiVisible())
            arraylist.add(new HomescreenModel(1, TEENPATTI, R.drawable.teen_patti, "Multi"));

        if (SharePref.getIsCustomVisible())
            arraylist.add(new HomescreenModel(3, CUSTOM_TABLE, R.drawable.custom_bot, "Multi"));

        if (SharePref.getIsPrivateVisible())
            arraylist.add(new HomescreenModel(2, PRIVATE_TABLE, R.drawable.private_table, "Multi"));

        if (SharePref.getIsHomeJackpotVisible())
            arraylist.add(new HomescreenModel(4, JACKPOT_3PATTI, R.drawable.jackpot_teen_pati, "All"));
        //      arraylist.add(new HomescreenModel(4, JACKPOT_3PATTI, R.drawable.home_jackpot, "All"));

        if (SharePref.getIsCarRouletteVisible())
            arraylist.add(new HomescreenModel(12, CAR_ROULETTE, R.drawable.car_roulette, "slots"));

        if (SharePref.getIsAnimalRouletteVisible())
            arraylist.add(new HomescreenModel(13, ANIMAL_ROULETTE, R.drawable.animal_roulette, "slots"));

        if (SharePref.getIsColorPredictionVisible())
            arraylist.add(new HomescreenModel(14, COLOUR_PREDICTION, R.drawable.colour_prediction, "slots"));

        if (SharePref.getIsSevenUpVisible())
            arraylist.add(new HomescreenModel(11, SEVEN_UP_DOWN, R.drawable.seven_updown, "slots"));

        if (SharePref.getIsPointRummyVisible())
            arraylist.add(new HomescreenModel(5, POINT_RUMMY, R.drawable.point_rummy, "Skills"));


        if (SharePref.getIsPoolRummyVisible())
            arraylist.add(new HomescreenModel(7, POOL_RUMMY, R.drawable.pool_rummy, "Skills"));

        if (SharePref.getIsDealRummyVisible())
            arraylist.add(new HomescreenModel(8, DEAL_RUMMY, R.drawable.deal_rummy, "Skills"));

        if (SharePref.getIsPrivateRummyVisible())
            arraylist.add(new HomescreenModel(6, PRIVATE_RUMMY, R.drawable.private_rummy, "Skills"));

        if (SharePref.getIsHeadTailVisible())
            arraylist.add(new HomescreenModel(16, HEAD_TAIL, R.drawable.head_and_tail, "slots"));

        if (SharePref.getIsRedBlackVisible())
            arraylist.add(new HomescreenModel(17, RED_BLACK, R.drawable.red_black, "slots"));

        if (SharePref.getBacarateVisible())
            arraylist.add(new HomescreenModel(21, BACCARAT, R.drawable.baccarat, "slots"));

        if (SharePref.getJhandi_MundaVisible())
            arraylist.add(new HomescreenModel(22, JHANDHI_MUNDA, R.drawable.jandi_munda, "slots"));

        if (SharePref.getIsLudoVisible())
            arraylist.add(new HomescreenModel(18, LUDO_GAME_PLAY_LOCAL, R.drawable.play_local_ludo, "slots"));

        if (SharePref.getIsLudoComputerVisible())
            arraylist.add(new HomescreenModel(20, LUDO_GAME_COMPUTER, R.drawable.ludo_user_v_computer, "Skills"));

        if (SharePref.getIsLudoOnlineVisible())
            arraylist.add(new HomescreenModel(19, LUDO_GAME_ONLINE, R.drawable.ludo_online, "multi"));

        if (SharePref.getRouletteVisible())
            arraylist.add(new HomescreenModel(23, ROULETTE, R.drawable.h_roulette, "slots"));

        if (SharePref.getIsPokerVisible())
            arraylist.add(new HomescreenModel(15, POKER_GAME, R.drawable.poker, "slots"));

        //    arraylist.add(new HomescreenModel(27, AVIATOR, R.drawable.avaitor, "slots"));

        arraylist.add(new HomescreenModel(28, MINES, R.drawable.mines, "slots"));

        if (SharePref.getTournamentVisible())
            arraylist.add(new HomescreenModel(24, TOURNAMENT, R.drawable.rummy_tournament, "Multi"));

        if (SharePref.getIsColorPrediction1Visible())
            arraylist.add(new HomescreenModel(25, COLOUR_PREDICTION1, R.drawable.colour_prediction, "slots"));

        if (SharePref.getIsColorPrediction3Visible())
            arraylist.add(new HomescreenModel(26, COLOUR_PREDICTION3, R.drawable.colour_prediction, "slots"));
...
//                                i.putExtra(SEL_TABLE,pool_boot);
    ...
    private void ChangeTextviewColorChange(int colortype) {
        ...
        if (colortype == 2) {
            ...
            lnr_2player.setBackgroundColor(getResources().getColor(R.color.colormain));
            ...
            lnr_5player.setBackgroundColor(getResources().getColor(R.color.colormain));
...
//                alert.show();
                ...
                Dialog_Support(context, "Contact Us");
            }
        });
    ...
    private void ParseResponse(String response) {
        try {
            ...
            if (code.equalsIgnoreCase("200")) {
                ...
                Log.d("zxczx", new Gson().toJson(bannerModelArrayList));

                PicassoImageLoadingService picassoImageLoadingService = new PicassoImageLoadingService(context);
                Slider.init(picassoImageLoadingService);

                MainSliderAdapter adapter = new MainSliderAdapter(bannerModelArrayList);
...
//                Intent intent = new Intent(context, TeenPattiSocket.class);
        ...
        sBarpri.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                txtMaximumbetvaluepri.setText("Maximumbet Value : " + kvalue(valueformaxi) + "");
...
//        LoadDealRummyActiveTable(ActiveTables_BF.RUMMY2);
    ...
    public void openAviator() {
        //harsh change to aviator redirect to link
        Intent intent = new Intent(context, Aviator_Game_Activity.class);
        context.startActivity(intent);
        //   Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://4club.in"));
...
//            super.destroyItem(container, position, object);
    ...
    public void Dialog_Support(Activity context, String title) {
        final Dialog dialog = Functions.DialogInstance(context);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        dialog.setTitle("");
        ...
        // ImageView fbLink = dialog.findViewById(R.id.fbLink);
        ImageView googleLink = dialog.findViewById(R.id.googleLink);
        // ImageView twitterLink = dialog.findViewById(R.id.twitterLink);
        // ImageView linkdnLink = dialog.findViewById(R.id.linkdnLink);
        // ImageView instaLink = dialog.findViewById(R.id.instaLink);
        ImageView telegramLink = dialog.findViewById(R.id.telegramLink);
        ...
        //     @Override
        //     public void onClick(View v) {
        //         sendURL("https://www.facebook.com/profile.php?id=61554742063668");
        //         dialog.dismiss();
        //     }
        // });
        ...
        //     @Override
        //     public void onClick(View v) {
        //         sendURL("https://www.instagram.com/jazzclub9801?igsh=YjUwdTlzMjhrYzZ5");
        //         dialog.dismiss();
        //     }
        // });
        telegramLink.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sendURL("https://t.me/magicteenpatt");
                dialog.dismiss();
            }
        });
        whatsApp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sendURL("https://wa.me/+919644772147");
                dialog.dismiss();
            }
        });
        googleLink.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //  sendURL("appmagicTeenpatti74@gmail.com");
                try {
                    Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("mailto:" + "magicteenpatti1@gmail.com"));
