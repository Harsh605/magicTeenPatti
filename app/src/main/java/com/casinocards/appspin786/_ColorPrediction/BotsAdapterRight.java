...
public class BotsAdapterRight extends RecyclerView.Adapter<BotsAdapterRight.ViewHolder> {
    ...
    private void updateCoins() {
        ...
        for (Bots_list bot : list) {
            ...
            int randomCoin = (int) (Math.random() * (10000 - 1000 + 1) + 1000);
        ...
        new android.os.Handler().postDelayed(this::updateCoins, subtractTime ? 10000 : 5000); // Call updateCoins() after 10 seconds initially, then every 5 seconds
    }
