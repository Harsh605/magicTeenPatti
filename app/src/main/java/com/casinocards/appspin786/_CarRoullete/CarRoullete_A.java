package com.casinocards.appmagicTeenpatti._CarRoullete;
...
import com.casinocards.appmagicTeenpatti._CarRoullete.menu.DialogRulesCarRoulette;
...
public class CarRoullete_A extends BaseActivity implements View.OnClickListener {
    ...
    // String[] gameInto = {
    //         "1.5X", "2.5X", "1.9X", "1X", "4X", "8X", "15X", "10X",
    // };
    String[] gameInto = {
