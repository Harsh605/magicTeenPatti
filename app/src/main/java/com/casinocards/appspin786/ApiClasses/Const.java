package com.casinocards.appmagicTeenpatti.ApiClasses;
...
public class Const {
 ...
 public static final String AVIATOR_MAIN = "https://admin.magicteenpatti.in/letscard/";  //URL FOR DEVELOPMENT

 //public static final String AVIATOR_MAIN = "http://134.209.152.157/letscard/";  //URL FOR DEVELOPMENT
 //public static final String AVIATOR_MAIN = "http://195.35.23.110/letscard/";  //URL FOR DEVELOPMENT
 ...
 public static final String AVIATOR_PROFILE_DETAILS = AVIATOR_MAIN + "/userById";
  ...
  // public static final String MAIN = "http://134.209.152.157/letscard/";  //URL FOR DEVELOPMENT
 //  public static final String MAIN = "http://195.35.23.110/letscard/";  //URL FOR DEVELOPMENT
   public static final String MAIN = "https://admin.magicteenpatti.in/letscard/";  //URL FOR DEVELOPMENT

// admintesting.appmagicTeenpatti.com/letscard//current base url
...
//    public static final String BSE_URL2 = MAIN2+"api/";
 ...
 public static final String USER_REFER_PURCHASE = BSE_URL+"User/purchase_reffer";
    ...
    public static final String IndianPayUpi = MAIN + "Home/indianpay3";
    public static final String IndianPayUpiStatus = MAIN + "Home/indianstatus2";


    public static final String PG_UPI = BSE_URL + "Upipay/index";
