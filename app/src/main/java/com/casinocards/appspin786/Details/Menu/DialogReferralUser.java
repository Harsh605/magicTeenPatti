...
import com.casinocards.appmagicTeenpatti.Details.Adapter.ReferalUserAdapter;
...
public class DialogReferralUser {
    ...
    final ArrayList<com.casinocards.appmagicTeenpatti.Details.Menu.ReferralModel> referralModels;
                ...
                try {
                    ...
                    if (code.equalsIgnoreCase("200")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            com.casinocards.appmagicTeenpatti.Details.Menu.ReferralModel model = new com.casinocards.appmagicTeenpatti.Details.Menu.ReferralModel();
