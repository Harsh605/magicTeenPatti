...
import com.casinocards.appmagicTeenpatti.Details.Adapter.ReferalLevelAdapter;
...
public class DialogReferralLevel {
    ...
    final ArrayList<com.casinocards.appmagicTeenpatti.Details.Menu.ReferralLevelModel> referralLevelModels;
...
//        Spinner dropdown = findViewById(R.id.spinner1);
        ...
        String[] items = new String[]{"Level","1", "2", "3"};
                ...
                try {
                    ...
                    if (code.equalsIgnoreCase("200")) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            com.casinocards.appmagicTeenpatti.Details.Menu.ReferralLevelModel model = new com.casinocards.appmagicTeenpatti.Details.Menu.ReferralLevelModel();
