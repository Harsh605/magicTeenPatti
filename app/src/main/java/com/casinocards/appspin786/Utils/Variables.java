...
public class Variables {
    ...
    public static final String NEOKARD_PAY = "neokard_pay";
    public static final String UPI = "UPi";
    public static final String NewUPI = "UPiPaymentNew";
    ...
    public static final String RUMMYGAME = "rummygame";     //for point rummy
    public static final String RUMMYGAMEDEAL = "rummygamedeal";
    public static final String RUMMYGAMEPOOL = "rummygamepool";
