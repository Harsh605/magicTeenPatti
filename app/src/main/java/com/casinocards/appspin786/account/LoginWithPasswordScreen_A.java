package com.casinocards.appmagicTeenpatti.account;
...
import com.casinocards.appmagicTeenpatti.Comman.DialogForgetPassword;
...
import com.casinocards.appmagicTeenpatti.Utils.ImageTakenSingleTone;
    ...
    private void loginwithPassword() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Const.login_withpassword,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Log.d("sssd",new Gson().toJson(response));
...
Log.d("cxcc",new Gson().toJson(stringRequest));
        Volley.newRequestQueue(this).add(stringRequest);
