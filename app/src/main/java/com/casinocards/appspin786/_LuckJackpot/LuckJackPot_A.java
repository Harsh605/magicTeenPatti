package com.casinocards.appmagicTeenpatti._LuckJackpot;
...
import com.casinocards.appmagicTeenpatti._LuckJackpot.menu.DialogJackpotHistory;
import com.casinocards.appmagicTeenpatti._LuckJackpot.menu.DialogJackpotlastWinHistory;
import com.casinocards.appmagicTeenpatti._LuckJackpot.menu.DialogRulesJackpot;
...
//        pure_sequence_amount = 0;
        ...
        for (int i = 0; i < rulesModelList.size(); i++) {
            JackpotRulesModel model = rulesModelList.get(i);  int betRuleTypeOn = model.rule_value;
            int putbetAmount = 0;
